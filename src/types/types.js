...
export const types = {
    ...
    loadDataMain: '[Data] Carga toda la informacion',
    ...
    purchaseAddProduct: '[Purchase] Add Product',
    purchaseProductDelete: '[Purchase] Delete one product',
    purchaseProductDeleteAll: '[Purchase] Delete all products'
}